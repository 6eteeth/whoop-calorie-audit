...
const entryCompletion = entry => ({ weight: hasValue(entry.weight_lb), nutrition: nutritionComplete(entry), workouts: workoutComplete(entry) })
  ...
  return <div className="public-page"><PublicHeader />
    <main>
      <section className="hero"><div className="hero-copy"><span className="pill">Your data. Your metabolism. Clearer answers.</span>
        ...
        <p>ZCore brings nutrition, body weight, workouts, and optional wearable data together to help you understand your real energy expenditure and long-term metabolic trends.</p>
      ...
      <section id="features" className="section"><div className="section-intro"><span className="eyebrow">One personal health dashboard</span><h2>Less guesswork. Better context.</h2><p>ZCore focuses on the numbers that matter most and keeps the analysis understandable.</p></div>
        <div className="feature-grid">
          ...
          <Feature icon="◎" title="Optional wearable analysis" text="Connect supported wearables when you want deeper recovery, sleep, activity, and calorie-comparison insights." />
          <Feature icon="3×" title="Flexible daily workout logging" text="Record up to three separate workouts with type, duration, and optional estimated calories—no wearable required." />
          ...
          <Feature icon="◉" title="Wearables are optional" text="Start with weight, macros, and workouts. Connect WHOOP or future integrations only when they add value." />
        </div>
      </section>
      ...
      <section id="how-it-works" className="section dark-section"><div className="section-intro"><span className="eyebrow">How it works</span><h2>A model that improves as your history grows.</h2></div>
        <div className="steps"><Step n="01" title="Log the essentials" text="Enter morning weight, macros, steps, and workout details. ZCore calculates intake automatically." /><Step n="02" title="Let trends stabilize" text="ZCore evaluates rolling windows rather than treating one unusual weigh-in as meaningful." /><Step n="03" title="Calibrate your numbers" text="Over time, ZCore estimates actual TDEE and can compare that estimate with any connected wearable." /></div>
      </section>
