...
function AdminDashboard() {
  ...
  return <section className="admin-panel">
    ...
    <div className="admin-metrics">
      ...
      <Metric label="28-day TDEE ready" value={formatNumber(data.summary.users_with_tdee_ready)} />
