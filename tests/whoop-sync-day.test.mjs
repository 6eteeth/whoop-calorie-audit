...
test('falls back to the scored cycle that ended the following local morning', () => {
  const endedThisMorning = cycle({
    id: 'completed-next-morning',
    start: '2026-08-09T07:05:00.000Z',
    end: '2026-08-09T14:00:00.000Z',
    offset: '-07:00',
    kilojoule: 10460,
    strain: 12.4,
  })
  const stillOpen = cycle({
    id: 'open-next-morning',
  ...
  assert.equal(selectCycle([stillOpen, endedThisMorning], '2026-08-08', '-07:00').id, 'completed-next-morning')
})
